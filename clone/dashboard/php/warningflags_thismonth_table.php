...
$getdata=$pdo->prepare("
		SELECT tprtable.teamname as teamname, tprtable.mentorname as mentorname, tprtable.warningflag as warningflag, tprtable.meetingdate as date 
		FROM tprtable 
