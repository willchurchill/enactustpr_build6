      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <table class="tabbedpage">
            <tr>
              <td>
                <button class="btn btn-lg btn-primary btn-block btn-on" type="submit">Top 5s</button>
              </td>
              <td>
                <a href="stats_hoursovertime.php">
                  <button class="btn btn-lg btn-primary btn-block btn-off" type="submit">Hours over time</button>
                </a>
              </td>
              <td>
...
<h2 class="page-header">Top 5s (this month)</h2>
  ...
  <td>
    <div class="table-responsive">
      <table class='table table-striped' id="tprtable">
        ...
        <tbody class="list">
          <?php echo $activementorsthismonth_events; ?>
        </tbody>
      </table>
    </div>
  </td>
  <td>
    <div class="table-responsive">
      <table class='table table-striped' id="tprtable">
        ...
        <tbody class="list">
          <?php echo $activementorsthismonth; ?>
        </tbody>
      </table>
    </div>
  </td>
  ...
  <td>
    <div class="table-responsive">
      <table class='table table-striped' id="tprtable">
        ...
        <tbody class="list">
          <?php echo $awardingmentorsthismonth; ?>
        </tbody>
      </table>
    </div>
  </td>
  <td>
    <div class="table-responsive">
      <table class='table table-striped' id="tprtable">
        ...
        <tbody class="list">
          <?php echo $scoringteamsthismonth; ?>
        </tbody>
      </table>
    </div>
  </td>
