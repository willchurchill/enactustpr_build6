    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li>&nbsp;&nbsp;Mentors</li>
			  ...
			  <li class="active"><a href="">Last month<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Last month's dashboard</h1>
...
<h2 class="sub-header">Last month's most popular topics were:</h2>
			<h3><?php echo $toptopics_lastmonth; ?></h3>
		<h2 class="sub-header">Mentors (listed by hours given) &middot; <span class="glyphicon glyphicon-print" aria-hidden="true" onclick="window.open('print/mentors_lastmonth.php', '_blank');" style="cursor:pointer;"></span></h2>
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("php/m_lastmonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
        </div>
