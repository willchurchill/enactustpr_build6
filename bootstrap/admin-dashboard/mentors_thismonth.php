    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li>&nbsp;&nbsp;Mentors</li>
			  <li class="active"><a href="mentors_thismonth.php">This month<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">This month's dashboard</h1>
...
<h2 class="sub-header">This month's most popular topics are:</h2>
		...
		<h2 class="sub-header">Mentors (listed by hours given) 
          ...
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("php/m_thismonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
