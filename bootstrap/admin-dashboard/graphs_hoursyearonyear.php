  ...
  <head>
    ...
    <!-- Include PHP scripts -->
	  <?php 
			...
			include("php/g_hoursyearonyear.php");
	  ?>
  </head>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
		  ...
		  <ul class="nav nav-sidebar">
            <li>&nbsp;&nbsp;Graphs</li>
			  ...
			  <li class="active"><a href="">Hours year on year<span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Graph generator</h1>
<form action="graphs_hoursyearonyear.php" method="GET" >
	      <div class="row placeholders">
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <h4>
				  <select class="topicselect" name="hoursselect">
					  <option value="total">Total</option>
					  <option value="ftf">Face to face</option>
					  <option value="phone">Phone / Skype</option>
			...
			<h2 class="sub-header">Comparing hours year on year: <?php echo $hourstype; ?></h2>
			<h3>
				<?php echo "
					<span class='topic1color'>&#9632;</span> ".$lastyear."/".$thisyear."&nbsp;&nbsp;&nbsp;
					<span class='topic3color'>&#9632;</span> ".($lastyear-1)."/".$lastyear."&nbsp;&nbsp;&nbsp;
					<span class='topic2color'>&#9632;</span> ".($lastyear-2)."/".($lastyear-1);
				?>
			</h3>
