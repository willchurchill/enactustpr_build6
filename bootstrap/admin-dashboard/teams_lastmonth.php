    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Team support last month</h1>
...
<!-- HIGHLIGHTS -->
          ...
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("php/highlights_lastmonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
<!-- END HIGHLIGHTS -->
<!-- FLAGS -->
          ...
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("php/warningflags_lastmonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
<!-- END FLAGS -->
<!-- SUPPORT REQUESTS -->
          ...
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("php/supportrequests_lastmonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
