    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="page-header">Team support this month</h2>
...
<!-- HIGHLIGHTS -->
          ...
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("tables/highlights_thismonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
<!-- END HIGHLIGHTS -->
		...
		<h3 class="sub-header">Flags</h3>
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("tables/warningflags_thismonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
<!-- END FLAGS -->
		...
		<h3 class="sub-header">Support Requests</h3>
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("tables/supportrequests_thismonth_table.php"); ?>
				  </tbody>
			  </table>
          </div>
