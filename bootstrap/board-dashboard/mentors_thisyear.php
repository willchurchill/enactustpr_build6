    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="page-header">This year's dashboard</h2>
...
<h3 class="sub-header">This year's most popular topics are:</h3>
          ...
          <h3 class="sub-header">Mentors (listed by hours given) &middot; <span class="glyphicon glyphicon-print" aria-hidden="true" onclick="window.open('print/mentors_thisyear.php', '_blank');" style="cursor:pointer;"></span></h3>
          <div class="table-responsive">
			  <table class='table table-striped'>
				  ...
				  <tbody>
					  <?php $format="web"; include_once("tables/m_thisyear_table.php"); ?>
				  </tbody>
			  </table>
          </div>
        </div>
